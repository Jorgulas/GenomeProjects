...
#### The implementations were carefully set so that they use concurrent threads in order to attain processing record speeds.
...
* [RunAll.kt](src/RunAll.kt) - Contains the main function to run all implementations sequentially.
